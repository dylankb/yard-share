  ...
  actions: {
    ...
    saveListing() {
      var params = {
        ...
        image1: this.get('image1') ? this.get('image'): "",
        image2: this.get('image2') ? this.get('image'): "",
        image3: this.get('image3') ? this.get('image'): "",
        image4: this.get('image4') ? this.get('image'): "",
        image5: this.get('image5') ? this.get('image'): "",
